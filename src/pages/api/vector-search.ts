...
export default async function handler(req: NextRequest) {
  try {
    ...
    const prompt = codeBlock`
      ${oneLine`
        Act as an expert in producing online video courses! Given the following sections from the badass.dev articles, 
        answer the question using only that information,
        outputted in markdown format. If you are unsure and the answer
        is not explicitly written in the articles on badass.dev, say
